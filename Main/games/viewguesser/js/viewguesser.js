...
function getJSON() {
    fetch('https://raw.githubusercontent.com/danevfx/dane.lol/main/games/viewguesser/json/videos.json').then (data => data.json()).then(data => {
        //  console.log(data);
        ...
        Swal.fire({
          ...
          html:
            ...
            '<img src="assets/instructions/example.gif" style="max-width:450px;">' +
...
function getEndscreenBackgrounds() {
  fetch('https://raw.githubusercontent.com/danevfx/dane.lol/main/games/viewguesser/json/endscreen-backgrounds.json').then (data => data.json()).then(data => {
